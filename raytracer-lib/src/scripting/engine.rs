...
pub fn register_vec_fns(engine: &mut Engine) {
	...
	/* Get and Set for Vec3d elements */
	fn get_x_vec2(v: &mut Vec3d) -> f64 { v.x }
	fn get_y_vec2(v: &mut Vec3d) -> f64 { v.y }

	fn set_x_vec2(v: &mut Vec3d, val: f64) { v.x = val; }
	fn set_y_vec2(v: &mut Vec3d, val: f64) { v.y = val; }

	/* Get and Set for Colour elements (renamed to r, g, b) */
	fn get_x_colour(v: &mut Vec3d) -> f64 { v.x }
	fn get_y_colour(v: &mut Vec3d) -> f64 { v.y }
	fn get_z_colour(v: &mut Vec3d) -> f64 { v.z }

	fn set_x_colour(v: &mut Vec3d, val: f64) { v.x = val; }
	fn set_y_colour(v: &mut Vec3d, val: f64) { v.y = val; }
	fn set_z_colour(v: &mut Vec3d, val: f64) { v.z = val; }
...
pub fn register_ray_fns(engine: &mut Engine) {
	fn get_origin(ray: &mut Ray) -> Vec3d { ray.origin }
	fn get_direction(ray: &mut Ray) -> Vec3d { ray.direction }
...
pub fn register_isect_fns(engine: &mut Engine) {
	fn get_point(isect: &mut Intersection) -> Vec3d { isect.point }
	fn get_ray(isect: &mut Intersection) -> Ray { isect.ray }
	fn get_normal(isect: &mut Intersection) -> Vec3d { isect.normal }
