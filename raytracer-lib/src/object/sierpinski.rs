...
const A1 : Vec3d = Vec3d{ x: 1.0, y: 1.0, z: 1.0 };
const A2 : Vec3d = Vec3d{ x: -1.0, y: -1.0, z: 1.0 };
const A3 : Vec3d = Vec3d{ x: 1.0, y: -1.0, z:  -1.0 };
const A4 : Vec3d = Vec3d{ x: -1.0, y: 1.0, z: -1.0 };
